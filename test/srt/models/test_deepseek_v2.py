...
class TestDeepseekV2MoE(unittest.TestCase):
    ...
    def test_fp8moe_blockscale_buffers_registration(self, *_):
        deepseek_v2._is_hip = True
        moe0 = deepseek_v2.DeepseekV2MoE(self.config, prefix="test")
        ...
        self.assertIs(moe0.experts.non_shared_topk_ids, moe1.experts.non_shared_topk_ids)
        self.assertIs(moe0.experts.total_topk_weights, moe1.experts.total_topk_weights)
        self.assertIs(moe0.experts.non_shared_topk_weights, moe1.experts.non_shared_topk_weights)
    
    def test_no_fp8moe_blockscale_buffers_registration(self, *_):
        deepseek_v2._is_hip = False
        moe0 = deepseek_v2.DeepseekV2MoE(self.config, prefix="test")
