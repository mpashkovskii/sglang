...
class AiterTopKRoutingBuffers:
    ...
    def __init__(self, top_k: int, n_routed_experts: int, n_shared_experts: int):
        ...
        shared_expert_ids = [n_routed_experts + i for i in range(n_shared_experts)]
        shared_topk_ids_list = [
            shared_expert_ids
        ] * AiterTopKRoutingBuffers.MAX_NUM_TOKENS
        ...
        self.non_shared_topk_weights, shared_topk_weights = (
            self.total_topk_weights.split([top_k, n_shared_experts], dim=1)
        )
    ...
    def register_in_layer(self, layer: nn.Module):
        ...
        layer.register_buffer(
            "total_topk_weights", self.total_topk_weights, persistent=False
        )
        layer.register_buffer(
